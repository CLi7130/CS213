...
public class currOrderController {
    ...
    @FXML // fx:id="currOrderDisplay"
    private TextArea currOrderDisplay; // Value injected by FXMLLoader
    ...
    void initialize() {
        ...
        assert currOrderDisplay != null : "fx:id=\"currOrderDisplay\" was not injected: check your FXML file 'currentOrder.fxml'.";
