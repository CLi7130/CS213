 ...
 *
 */
public class Order implements com.example.asst5.Customizable, Serializable {

    private int orderNumber;
    private ArrayList<com.example.asst5.MenuItem> orderList;
     ...
     */
    public ArrayList<com.example.asst5.MenuItem> getOrderList() {
        return orderList;
    }
     ...
     */
    public Order() {
        this.orderList = new ArrayList<com.example.asst5.MenuItem>();
    ...
    public boolean add(Object obj) {
        this.removeNulls();
        if(obj instanceof com.example.asst5.MenuItem) {
            
            com.example.asst5.MenuItem tempObj = (com.example.asst5.MenuItem) obj;
    ...
    public boolean remove(Object obj) {
        if(obj instanceof com.example.asst5.MenuItem) {
        	this.removeNulls();
        	com.example.asst5.MenuItem deleteThisItem = (com.example.asst5.MenuItem) obj;
     ...
     */
    private int find(com.example.asst5.MenuItem menuItem) {
        int index = 0;
    ...
    */
    ...
    public double updateOrderTotal() {
    	double total = 0;
    	this.removeNulls();
        for(com.example.asst5.MenuItem menuItems : orderList) {
