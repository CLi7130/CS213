...
public class Library {
    ...
    */
    ...
    /**
    Sorts book array by Date by utilizing sum of year, month, day.
    Uses Insertion Sort, and a unique sum generated by adding year/month/day to organize books by date. Books with the same publishing date are grouped, but not sorted further.
    */
